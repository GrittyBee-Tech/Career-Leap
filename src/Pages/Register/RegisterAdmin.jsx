...
const RegisterAdmin = () => {
  ...
  return (
    <section className="w-full md:w-[90%] lg:w-4/5 flex sm:flex-row flex-col bg-white items-center m-auto my-10 gap-10 sm:gap-8 md:gap-12">
        ...
        <div className='w-full sm:flex-1 mb-4 bg-[#EAF6FC] sm:mb-0 border-2 border-[#0000ff] rounded-3xl px-10 sm:px-7 md:px-12 py-8 flex flex-col gap-5'>
            ...
            <form action="" className='flex flex-col gap-4' onSubmit={handleSubmit(onsubmit)}>
              <div>
                <label className='pb-2.5 font-medium text-xl font-plus-jakarta-sans' htmlFor='email'>Email</label>
              ...
              <div>
                <label className='pb-2.5 font-medium text-xl font-plus-jakarta-sans' htmlFor='password'>Password</label>
                <div className='relative'>
                  <input
                    name='password'
              ...
              <div>
                <label className='pb-2.5 font-medium text-xl font-plus-jakarta-sans' htmlFor='organization'>Organization name</label>
                <input
                  name='organization'
                  type='text'
              ...
              <div>
                <label className='pb-2.5 font-medium text-xl font-plus-jakarta-sans' htmlFor='role'>Register as</label>
                <select
                  name='role'
                  placeholder='Manager'
                  className={`w-full border ${errors.role ? 'border-red-500' : 'border-[#0A0A29]'} rounded-md outline-none p-2.5 leading-none font-medium text-lg placeholder:text-[#C8C8DC]`}
                  {...register('role')}
                >
