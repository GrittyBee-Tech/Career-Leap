...
const Health = () => {
    ...
    return (
        <section id="Health">
            <div className="container mx-auto w-[85%] mt-11  lg:flex gap-[140px] lg:mt-[90px] mb-[40px] lg:mb-[90px]">
                <div>
                    ...
                    <div className="flex gap-3 md:mt-[30px] mt-8" data-aos="fade-right">
                    ...
                    <div className="flex gap-3  md:mt-7  mt-5 mb-5" data-aos="fade-right">
                        <img className="w-[45px] h-[45px]" src={check} alt="check" />
                    ...
                    <div className="flex gap-3 md:mt-11 mt-1 mb-11" data-aos="fade-right">
                        <img className="w-[45px] h-[45px]" src={check} alt="check" />
