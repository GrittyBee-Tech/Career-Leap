...
const Hero = () => {
    ...
    return (
        <section id="Hero">
            ...
            <div className="md:flex pt-[5rem] lg:flex container mx-auto w-[85%] mt-5 lg:gap-[120px] md:gap-[15px]">
                <div>
                    ...
                    <Link to="/admin/register">
                        <button className=" mt-7  lg:mt-[60px] w-[198px] h-[60px] bg-[#00F] text-[#FFFF]  font-bold text-[24px] rounded">Get Started</button></Link>
