        ...
        <section id="Hero">
            ...
            <div className="md:flex  container mx-auto w-[85%] mt-5 lg:gap-[120px] md:gap-[5px]">
                <div>
                    ...
                    <p className="md:text-[24px]  text-[18px]  md:w-[486px] h-[60px]  mt-8 font-plus-jakarta-sans " data-aos="fade-left">Give your employees a voice and help them to grow.</p>
