    ...
    return (
        <section id="Hero">
            ...
            <div className="md:flex  container mx-auto w-[85%] mt-5 gap-[120px]">
                <div>
                    <p className=" md:text-[45px]  text-[25px]  md:w-[515px] mt-[70px] font-normal  font-georgia">Build a more engaged and productive workforce with <span className="font-lobster text-[#00F]"> RisePath</span></p>
