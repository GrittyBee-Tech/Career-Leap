    ...
    return (
        <section>
            ...
            <div className="md:flex  container m-auto w-[85%] mt-5 gap-[120px]">
                <div>
                    <p className=" md:text-[45px]  text-[20px]  md:w-[515px] mt-[70px] font-normal">Build a more engaged and productive workforce with <span className="font-lobster text-[#00F]"> CareerLeap</span></p>
                    <p className="text-[24px]   md:w-[486px] h-[60px] mt-8 font-plus-jakarta-sans">Give your employees a voice and help them to grow.</p>
