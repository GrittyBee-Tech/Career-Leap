        ...
        <section id="Upskills">
            ...
            <div className="container mx-auto w-[85%] mt-1  lg:flex gap-[140px]">
                ...
                <div className="mt-[60px]" data-aos="fade-right">
                    ...
                    <div className="flex gap-4  md:mt-7  mt-5 " data-aos="fade-right" >
                    ...
                    <div className="flex gap-4  md:mt-2  mt-5 " data-aos="fade-right">
                        <img className="w-[45px] h-[45px]" src={check} alt="check" />
                    ...
                    <div className="flex gap-3  md:mt-[60px]  mt-5  mb-[60px]" data-aos="fade-right">
                        <img className="w-[45px] h-[45px]" src={check} alt="check" />
                        <p className="w-[446px] h-[60px] text-[#0A0A29] md:text-[24px] font-normal font-plus-jakarta-sans">
                ...
                <div className="mt-[90px]" data-aos="flip-down">
