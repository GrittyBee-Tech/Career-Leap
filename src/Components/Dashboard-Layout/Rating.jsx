...
import dash from "../../assets/Icons/right.png";
import icon from "../../assets/Icons/sign.png";
    ...
    <section className="flex flex-wrap gap-4 mb-4">
      <div className="bg-[white] shadow-lg rounded-lg py-2.5 pl-2.5 pr-6 flex gap-4 h-24 border">
        <div className="flex flex-col justify-between">
          ...
          <p className="text-xs font-plus-jakarta-sans font-medium"> 0/240</p>
          <p className="text-xs font-plus-jakarta-sans font-medium border-l-blue-600 border-l-2 pl-2">No Score</p>
        </div>

        <div className="relative">
          <img src={rate} alt="rate" width={72} />
          <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-plus-jakarta-sans font-medium text-xs">00.0%</p>
        </div>
      </div>
      ...
      <div className="bg-[white] shadow-lg rounded-lg flex gap-3 p-3 h-24 items-stretch">
        <div className="flex flex-col justify-between">
          ...
          <p className="text-xs font-plus-jakarta-sans font-medium mt-2">0%</p>
          <p className="text-xs font-plus-jakarta-sans font-medium border-x-blue mt-2">No score</p>
        </div>
