...
const RegisterModal = ({ setIsModalOpen, isModalOpen }) => {
  return (
    <section className={`h-screen w-full justify-center items-center bg-[#EAF6FC] registerOptions fixed inset-0 transition duration-500 ease-in-out ${isModalOpen ? 'flex' : 'hidden'}`}>
